                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('firstName') is-invalid @enderror" type="text" name="lastName" id="lastName" value="{{ old('lastname') }}" placeholder="Enter Last Name">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('firstName') is-invalid @enderror" type="text" name="email" id="email" value="{{ old('email') }}" placeholder="Enter Email">
                            @if ($errors->has('email'))
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('firstName') is-invalid @enderror" type="text" name="age" id="age" value="{{ old('age') }}" placeholder="Enter Age">
                            @if ($errors->has('age'))
